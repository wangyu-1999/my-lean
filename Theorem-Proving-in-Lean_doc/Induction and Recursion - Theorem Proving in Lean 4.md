# <a href="https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#induction-and-recursion" id="induction-and-recursion" class="header">Induction and Recursion</a>
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#pattern-matching" id="pattern-matching" class="header">Pattern Matching</a>
...
Lean can also handle more complex forms of pattern matching, in which arguments to dependent types pose additional constraints on the various cases. Such examples of *dependent pattern matching* are considered in the [Section Dependent Pattern Matching](https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#dependent_pattern_matching).

## <a href="https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#a-namewildcards_and_overlapping_patternsawildcards-and-overlapping-patterns" id="a-namewildcards_and_overlapping_patternsawildcards-and-overlapping-patterns" class="header"></a><span id="wildcards_and_overlapping_patterns"></span>Wildcards and Overlapping Patterns
...
.. TO DO: eventually, describe using\_well\_founded.

.. \_nested\_and\_mutual\_recursion:

## <a href="https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#a-name_nested_and_mutual_recursiona-mutual-recursion" id="a-name_nested_and_mutual_recursiona-mutual-recursion" class="header"></a><span id="_nested_and_mutual_recursion"></span> Mutual Recursion
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#a-name_dependent_pattern_matchinga-dependent-pattern-matching" id="a-name_dependent_pattern_matchinga-dependent-pattern-matching" class="header"></a><span id="_dependent_pattern_matching"></span> Dependent Pattern Matching
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#a-name_inaccessible_patternsainaccessible-patterns" id="a-name_inaccessible_patternsainaccessible-patterns" class="header"></a><span id="_inaccessible_patterns"></span>Inaccessible Patterns
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#a-name_match_expressionsamatch-expressions" id="a-name_match_expressionsamatch-expressions" class="header"></a><span id="_match_expressions"></span>Match Expressions
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#local-recursive-declarations" id="local-recursive-declarations" class="header">Local recursive declarations</a>
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#exercises" id="exercises" class="header">Exercises</a>
...
4.  Following the examples in [Section Dependent Pattern Matching](https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html#dependent_pattern_matching), define a function that will append two vectors. This is tricky; you will have to define an auxiliary function.
