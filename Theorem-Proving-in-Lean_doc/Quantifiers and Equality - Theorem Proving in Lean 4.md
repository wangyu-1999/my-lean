# <a href="https://leanprover.github.io/theorem_proving_in_lean4/quantifiers_and_equality.html#quantifiers-and-equality" id="quantifiers-and-equality" class="header">Quantifiers and Equality</a>
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/quantifiers_and_equality.html#the-universal-quantifier" id="the-universal-quantifier" class="header">The Universal Quantifier</a>
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/quantifiers_and_equality.html#equality" id="equality" class="header">Equality</a>

Let us now turn to one of the most fundamental relations defined in Lean's library, namely, the equality relation. In [Chapter Inductive Types](https://leanprover.github.io/theorem_proving_in_lean4/inductive_types.html), we will explain *how* equality is defined from the primitives of Lean's logical framework. In the meanwhile, here we explain how to use it.
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/quantifiers_and_equality.html#a-name_calc_proofsacalculational-proofs" id="a-name_calc_proofsacalculational-proofs" class="header"></a><span id="_calc_proofs"></span>Calculational Proofs
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/quantifiers_and_equality.html#the-existential-quantifier" id="the-existential-quantifier" class="header">The Existential Quantifier</a>
...
We will see in [Chapter Induction and Recursion](https://leanprover.github.io/theorem_proving_in_lean4/induction_and_recursion.html) that all these variations are instances of a more general pattern-matching construct.
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/quantifiers_and_equality.html#more-on-the-proof-language" id="more-on-the-proof-language" class="header">More on the Proof Language</a>
...
## <a href="https://leanprover.github.io/theorem_proving_in_lean4/quantifiers_and_equality.html#exercises" id="exercises" class="header">Exercises</a>
